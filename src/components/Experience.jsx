      ...
      <div className="relative w-full max-w-4xl mx-auto">
        ...
        <div className="relative flex flex-col md:flex-row justify-end md:justify-between items-start md:items-center w-full mb-12 pl-12 md:pl-0 fade-up">
          <div className="hidden md:block w-[45%] text-right pr-8">
            <span className="font-code-sm text-code-sm text-primary">{t.items[0].period}</span>
          </div>
          ...
          <div className="w-full md:w-[45%] pl-0 md:pl-8">
            <span className="md:hidden font-code-sm text-code-sm text-primary block mb-2">{t.items[0].period}</span>
            <div className="glass-panel glass-panel-hover rounded-xl p-6">
              <h3 className="font-headline-md text-headline-md text-on-background mb-1">{t.items[0].role}</h3>
              <h4 className="font-body-md text-body-md text-on-surface-variant mb-4">{t.items[0].company}</h4>
              <p className="font-body-md text-body-md text-on-surface-variant opacity-80 text-sm">{t.items[0].description}</p>
            </div>
          </div>
        </div>
      </div>
